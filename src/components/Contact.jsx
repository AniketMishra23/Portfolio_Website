...
// Formspree setup:
// 1. Sign up at https://formspree.io with mishraaniket557@gmail.com
// 2. Create a new form → copy the form ID (e.g. "xpzgkqbd")
// 3. Create .env.local in the project root: VITE_FORMSPREE_ID=your_form_id_here
  ...
  return (
    <section id="contact" className="py-16 sm:py-24 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-12 mt-10 sm:mt-12">
          {/* Left */}
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-slate-300 mb-2 text-sm sm:text-base font-medium">Let's build something together.</p>
            ...
            <div className="space-y-3 sm:space-y-4">
              {socials.map(({ icon: Icon, label, href }) => (
                ...
                >
                  <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg border border-[#00f5ff22] group-hover:border-[#00f5ff66] flex items-center justify-center transition-colors shrink-0">
                    <Icon size={15} />
                  </div>
